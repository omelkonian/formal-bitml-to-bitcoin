...
module _ (𝕣 : ℝ R) t (α : Label) ad Γ₀ where
  open ℝ 𝕣
  private
    g = G ad
    Γ = ` ad ∣ Γ₀
...
--       ad∈ = {!!}
--       -- rewrite cfg≡ = ∈-++⁺ʳ (advertisements $ Γ₁ ∣ Γ₂) ad∈₀
