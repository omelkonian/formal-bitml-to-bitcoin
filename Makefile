...
travis-setup:\
	...
	$(HOME)/formal-bitcoin-master/Bitcoin/Main.agda\
	$(HOME)/formal-bitml-master/BitML/Main.agda\
	$(HOME)/.agda/libraries
...
$(HOME)/formal-bitcoin-master/Bitcoin/Main.agda:
	curl -L https://github.com/omelkonian/formal-bitcoin/archive/master.zip -o $(HOME)/formal-bitcoin-master.zip
	unzip -qq $(HOME)/formal-bitcoin-master.zip -d $(HOME)

$(HOME)/formal-bitml-master/BitML/Main.agda:
	curl -L https://github.com/omelkonian/formal-bitml/archive/master.zip -o $(HOME)/formal-bitml-master.zip
	unzip -qq $(HOME)/formal-bitml-master.zip -d $(HOME)
...
$(HOME)/.agda/libraries:
	...
	echo "$(HOME)/formal-bitcoin-master/formal-bitcoin.agda-lib"                >> $(HOME)/.agda/libraries
	echo "$(HOME)/formal-bitml-master/formal-bitml.agda-lib"                    >> $(HOME)/.agda/libraries
